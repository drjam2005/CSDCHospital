...
int main() {
	...
	cout << "-------------------------------------   Add   -------------------------------------\n";
	cout << "- (1) Add Patient                             (2) Add Doctor                      -\n";
	cout << "-------------------------------------   Set   -------------------------------------\n";
	cout << "- (3) Set Doctor Schedule                     (4) Set Appointment                 -\n";
	cout << "-------------------------------------  Print  -------------------------------------\n";
	cout << "- (5) Print Patients                          (6) Print Doctors                   -\n";
	cout << "- (7) Print Patient Appointments                                                  -\n";
	cout << "------------------------------------- Records -------------------------------------\n";
	cout << "- (8) Record Checkup                                                              -\n";
	cout << "------------------------------------- Removes -------------------------------------\n";
	cout << "- (9) Remove Patient                          (10) Remove Doctor                  -\n";
	std::cout << "------------------------------------- Special -------------------------------------\n";
	cout << "- (11) Get Doctor From Specializaiton                                             -\n";
	cout << "-------------------------------------  Edits  -------------------------------------\n";
	cout << "- (12) Edit Doctor                            (13) Edit Patient                   -\n";
	cout << "-----------------------------------------------------------------------------------\n";
	cout << "  (14) Exit  -\n";
	cout << "--------------\n";
	cout << log;
